            ...
            <div class="contentArea">
                ...
                <form action="<?php echo U('Siteinfo/add_nav');?>" method="post">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        ...
                        <tr>
                            <th>页面标题：</th>
                            <td><input class="input" name="title" type="text" size="40" value="<?php echo ($info["title"]); ?>" /> 用于SEO优化的页面标题</td>
                        </tr>
                        <tr>
                            <th>关键字：</th>
                            <td><input class="input" name="keywords" type="text" size="40" value="<?php echo ($info["keywords"]); ?>" /> 用于SEO优化的关键字</td>
                        </tr>
                        <tr>
                            <th>描述信息：</th>
                            <td><textarea name="description" id="" cols="40" rows="3"><?php echo ($info["description"]); ?></textarea> 用于SEO优化的描述信息</td>
                        </tr>
                    </table>
