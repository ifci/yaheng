                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="url1" class="input" size="40" name="image" value="<?php echo ($img_info["savepath"]); ?>"/>
                                    ...
                                    <input type="button" class="btn " id="image1" value="选择图片" />(图片尺寸：245*150)</td>
                            </tr>
                            <tr>
                                <th>文章关键词：</th>
            ...
            $(function(){var  content ;
                KindEditor.ready(function(K) {
                    content = K.create('#content',{
                        ...
                        uploadJson:'/yaheng/Public/kindeditor/php/upload_json.php?dirname=news'
                    });
                });
                $("#checkNewsTitle").click(function(){
                    $.getJSON("/yaheng/jkd/News/checkNewsTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
