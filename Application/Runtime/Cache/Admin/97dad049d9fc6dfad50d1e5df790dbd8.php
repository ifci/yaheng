                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                    ...
                    <tr>
                        ...
                        <td><select name="info[unique_id]" id="">
                            <option value="dzlc" <?php echo $info['unique_id'] == 'dzlc'?'selected':'';?>>定制流程</option>
                            <option value="ppjj" <?php echo $info['unique_id'] == 'ppjj'?'selected':'';?>>品牌简介</option>
                            <option value="ppwh" <?php echo $info['unique_id'] == 'ppwh'?'selected':'';?>>品牌文化</option>
                            <option value="pplx" <?php echo $info['unique_id'] == 'pplx'?'selected':'';?>>品牌路线</option>
                            <option value="ppdl" <?php echo $info['unique_id'] == 'ppdl'?'selected':'';?>>品牌代理</option>
                            <option value="dltj" <?php echo $info['unique_id'] == 'dltj'?'selected':'';?>>代理条件</option>
                            <option value="dllc" <?php echo $info['unique_id'] == 'dllc'?'selected':'';?>>代理流程</option>
                        </select></td>
                    </tr>
    ...
    $(function(){
        ...
        KindEditor.ready(function(K) {
            content = K.create('#content',{
                ...
                uploadJson:'/yaheng/Public/kindeditor/php/upload_json.php?dirname=page'
            });
        });
        ...
        $("#checkPageTitle").click(function(){
            ...
            $.getJSON("/yaheng/jkd/Siteinfo/checkPageTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
        ...
        $("#checkPageUnique").click(function(){
            ...
            $.getJSON("/yaheng/jkd/Siteinfo/checkPageUnique", { title:$("#unique_id").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
