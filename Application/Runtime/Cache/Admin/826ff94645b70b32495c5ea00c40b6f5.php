...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>产品分类管理-产品管理-后台管理首页-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='产品管理 > 年份/季节'; ?>
...
<div class="clear"></div>
    ...
    <div class="subMenuList">
            ...
            <?php if(is_array($sub_menu)): foreach($sub_menu as $key=>$sv): ?><li><a href="<?php echo ($sv["url"]); ?>"><?php echo ($sv["title"]); ?></a></li><?php endforeach; endif; ?>
                ...
                <div id="Right">
                    ...
                    <form action="" method="post" id="quickForm">
                        ...
                        <?php } ?>
                        <input type="hidden" name="data[type]" value="s">
                        <input placeholder="需要添加的时节名称" id="newName" class="input" type="text" name="data[name]" value="" /> &nbsp;
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab">
                        ...
                        <tbody>
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tree): $mod = ($i % 2 );++$i;?><tr pid="<?php echo ($tree["pid"]); ?>" cid="<?php echo ($tree["cid"]); ?>">
                                    ...
                                    <td width="10%" class="tree" style="cursor: pointer;"><?php echo ($tree["fullname"]); ?><div></div></td>
                                    <td width="20%">
        ...
        <form action="" method="post" id="opForm">
            <input id="type" type="hidden" name="data[type]" value="s" />
