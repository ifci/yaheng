...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='案例管理 > 添加案例'; ?>
            ...
            <form>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                    ...
                    <tr>
                        ...
                        <td><label><input type="radio" name="info[status]" value="1" <?php if($info["status"] == 1): ?>checked="checked"<?php endif; ?> /> 已发布状态</label> &nbsp; <label><input type="radio" name="info[status]" value="0" <?php if($info["status"] == 0): ?>checked="checked"<?php endif; ?> /> 待审核状态</label></td>
                    </tr>
                    <tr>
                        <th width="100">排序：</th>
                        <td><input id="sort" type="text" class="input" size="8" name="info[sort]" value="<?php echo ($info["sort"]); ?>"/></td>
                    </tr>
                    <tr>
                        <th>案例图片：</th>
                        <td>
    ...
    $(function(){
        ...
        KindEditor.ready(function(K) {
            content = K.create('#content',{
                ...
                uploadJson:'/yaheng/Public/kindeditor/php/upload_json.php?dirname=case'
            });
        });
        ...
        $("#checkPageTitle").click(function(){
            ...
            $.getJSON("/yaheng/jkd/Case/checkPageTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
