        ...
        <div id="Right">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                        ...
                        <td><a title="审核状态" href="javascript:void(0);" onclick="changeStatus(<?php echo ($vo["id"]); ?>,this)"><img src="/yaheng/Public/Img/action_<?php echo ($vo["display"]); ?>.png" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a link="<?php echo U('Siteinfo/delmessage/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="<?php echo ($vo["id"]); ?>" class="del"><img src="/yaheng/Public/Img/action_remove.png" border="0"></a> </td>
