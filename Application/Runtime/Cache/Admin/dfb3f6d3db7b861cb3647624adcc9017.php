                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        ...
                        <tr>
                            ...
                            <td><select name="info[position]" style="width: 140px;">
                                ...
                                <option value="news" <?php if($info['position'] == 'news'): ?>selected<?php endif; ?>>新闻活动</option>
                                <option value="agent" <?php if($info['position'] == 'agent'): ?>selected<?php endif; ?>>品牌代理</option>
                        ...
                        <tr>
                            <th>图片显示：</th>
                            <td><a href="/yaheng/Uploads/picture/<?php echo ($info["ad_img"]); ?>" target="_blank"><img src="/yaheng/Uploads/picture/<?php echo ($info["ad_img"]); ?>" border="0" height="40" width="200"></a></td>
                        </tr>
                        <?php } ?>
