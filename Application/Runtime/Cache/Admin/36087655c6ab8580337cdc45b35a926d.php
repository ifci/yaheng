                ...
                <div id="Right">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                <!--<td><a href="javascript:void(0);" onclick="changeAttr(<?php echo ($vo["id"]); ?>,this)"><img src="/yaheng/Public/Img/action_<?php echo ($vo["is_recommend"]); ?>.png" border="0"></a>
                                    </if></td>-->
                                <td>[ <a href="/yaheng/jkd/News/edit?id=<?php echo ($vo["id"]); ?>">编辑 </a> ] [ <a link="<?php echo U('News/del/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="<?php echo ($vo["title"]); ?>" class="del">删除 </a> ]</td>
