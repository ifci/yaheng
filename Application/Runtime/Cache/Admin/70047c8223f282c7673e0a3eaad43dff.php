...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>添加、编辑图片-后台管理-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='添加编辑图片'; ?>
        ...
        <script type="text/javascript">
            ...
            KindEditor.ready(function(K) {
                var editor = K.editor({
                    ...
                    uploadJson:'/yaheng/Public/kindeditor/php/upload_json.php?dirname=gif'
                });
                //触发添加图片
