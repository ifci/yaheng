...
<section>
    <div class="main">
        ...
        <?php if(is_array($ct)): $i = 0; $__LIST__ = $ct;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="pro_tit">
            <span><?php echo ($v["ename"]); ?></span>
        ...
        <div class="pro_list">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "此分类暂无相关信息" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['cid'] == $v['cid']): ?><li>
                    <a href="<?php echo ($vo['url']); ?>" target="_blank"><img src="<?php echo get_default_img($vo['image_id']);?>" alt=""/></a>
