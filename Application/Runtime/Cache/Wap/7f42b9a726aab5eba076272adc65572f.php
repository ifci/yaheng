    ...
    <div class="news">
        <ul class="clearfix">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <a href="<?php echo U('news_r/'.$vo['id']);?>">
                        <div class="box"><img src="<?php echo get_default_img($vo['image_id']);?>" /></div>
                        <div class="tit"><?php echo ($vo["title"]); ?></div>
                        <div class="txt"><?php echo (msubstr($vo["summary"],0,30)); ?></div>
        ...
        <!--分页-->
        <?php echo ($count > 4 ? '<div class="paging"><a href="javascript:" class="add_more">加载更多</a></div>' : false); ?>
