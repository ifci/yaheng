...
<section>
    <div class="haute">
        <div class="haute_t">
            <h4>高级定制案例展示</h4>
            <div class="ftxt">高级定制，“奢华需要精致的细节表现”</div>
            <div class="tel">
                <i></i>
                <span>联系热线</span>
                <em><?php echo ($site["tel"]); ?></em>
            </div>
        </div>
        <div class="haute_c">
            <!-- Swiper -->
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <?php if(is_array($case)): $i = 0; $__LIST__ = $case;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="swiper-slide"><img src="<?php echo get_default_img($vo['image_id']);?>" alt=""/></div><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <!-- Add Pagination -->
        ...
        <div class="haute_c">
            ...
            <div class="haute_btn">
                <a href="/yaheng/wap/enroll">我要定制</a>
            </div>
        </div>
    </div>
</section>
