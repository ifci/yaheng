...
<head>
    ...
    <meta name="format-detection" content="telephone=no,email=n.o,adress=no">
...
<div class="header">
    <div class="pr clearfix header_wrap">
        ...
        <div class="sharebar">
            ...
            <a href="<?php echo ($site["weibo"]); ?>" title="亚恒官方微博" class="s_wb" target="_blank"><i></i></a>
            <div class="sharebar_con"><span>咨询热线：<b><?php echo ($site["tel"]); ?></b></span><span><img src="/yaheng/Public/Home/images/qrcode.jpg" alt=""/></span></div>
        </div>
    </div>
</div>
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide" style="background-image: url(/yaheng/Public/Home/images/Slide2.jpg)">
            <div class="center">
                ...
                <div class="darkButton darkButton-white fade"><a href="<?php echo U('/product/62');?>" title="购买皮草"><span>购买皮草</span><i></i></a></div>
            </div>
        </div>
        ...
        <div class="swiper-slide" style="background-image: url(/yaheng/Public/Home/images/Slide3.jpg)">
            <div class="center">
                ...
                <div class="darkButton darkButton-white fade"><a href="<?php echo U('/product/61');?>" title="购买皮衣"><span>购买皮衣</span><i></i></a></div>
            </div>
        </div>
        ...
        <div class="swiper-slide" style="background-image: url(/yaheng/Public/Home/images/Slide8.jpg)">
            <div class="center">
                <div class="slide-18 dynamic">
                    <?php if(is_array($gif)): $i = 0; $__LIST__ = $gif;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src="<?php echo ($vo["savepath"]); ?>"/><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
        </div>
                ...
                <div class="news_list">
                    <ul class="clearfix">
                        <?php if(is_array($news_list)): $i = 0; $__LIST__ = $news_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <div class="box">
                                <a href="<?php echo U('/news_r/'.$vo['id']);?>" title="<?php echo ($vo["title"]); ?>">
                                    <div class="day"><?php echo (date('d',$vo["published"])); ?></div>
                                    <div class="date"><?php echo (date('Y.m',$vo["published"])); ?></div>
