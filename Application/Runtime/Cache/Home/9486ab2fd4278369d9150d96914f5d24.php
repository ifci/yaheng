...
<div class="bread">
    <span>当前位置：</span><a href="/yaheng/" title="首页">首页</a><i>></i><a href="<?php echo U('/'.strtolower(CONTROLLER_NAME));?>" title="<?php echo ($bread); ?>"><?php echo ($bread); ?></a><?php if($details == 1): ?><i>></i><a href="/yaheng/bety.html" title="<?php echo ($info['title']); ?>"><?php echo ($info['title']); ?></a><?php endif; ?>
</div>
<div class="content">
    ...
    <div class="btm_b">
        ...
        <div class="btm_b_w">
            <div class="btm_b_p1">
                <img src="/yaheng/Public/Home/images/logo.png" alt="蓓特蔓" />
            </div>
            <?php echo ($pplx); ?>
        </div>
    </div>
