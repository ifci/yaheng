...
<div class="bread">
    <span>当前位置：</span><a href="/yaheng/" title="首页">首页</a><i>></i><a href="<?php echo U('/'.$b_url);?>" title="<?php echo ($webtitle); ?>"><?php echo ($webtitle); ?></a><?php if($details == 1): ?><i>></i><a href="/yaheng/release.html" title="<?php echo ($info['title']); ?>"><?php echo ($info['title']); ?></a><?php endif; ?>
</div>
<div class="content">
    <!--新品发布-->
    <div class="release">
        <ul class="clearfix">
            <li><img src="/yaheng/Public/Home/images/pic_17.jpg" alt=""/></li>
