...
<div class="bread">
    <span>当前位置：</span><a href="/yaheng/" title="首页">首页</a><i>></i><a href="<?php echo U('/'.strtolower(CONTROLLER_NAME));?>" title="<?php echo ($bread); ?>"><?php echo ($bread); ?></a><?php if($details == 1): ?><i>></i><a href="/yaheng/news.html" title="<?php echo ($info['title']); ?>"><?php echo ($info['title']); ?></a><?php endif; ?>
</div>
<!--content开始-->
    <div id="content">
        <div class="main_t">
            <img src="/yaheng/Uploads/picture/<?php echo ($ad_info2[0]["ad_img"]); ?>" alt="<?php echo ($ad_info2[0]["ad_name"]); ?>"/>
        </div>
        <div class="news_list">
            <ul class="clearfix">
