...
CREATE TABLE `jkd_news` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='新闻表' ;
...
# 数据库表：jkd_nav 数据信息
INSERT INTO `jkd_nav` VALUES ('61','link','高级定制','0','0','top','','zh-cn','4','0','haute','','','');
INSERT INTO `jkd_nav` VALUES ('56','link','品牌代理','0','0','top','','zh-cn','3','0','agent','','','');
INSERT INTO `jkd_nav` VALUES ('57','news','新闻活动','0','1','top','','zh-cn','2','0','news','','','');
INSERT INTO `jkd_nav` VALUES ('67','link','联系蓓特蔓','0','0','top','','zh-cn','0','0','contact','','','');
